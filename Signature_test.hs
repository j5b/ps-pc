...
-- testing the isNNF function

isnnfTest1 = TestCase (assertBool "isNNF simple 1" (isNNF bottom))
isnnfTest2 = TestCase (assertBool "isNNF simple 2" (isNNF simple6))
isnnfTest3 = TestCase (assertBool "not NNF" (not (isNNF (Neg simple3))))
